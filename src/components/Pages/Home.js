...
import { SignOutCard, RecipeCard, SearchCard } from '../Cards';
...
export const Home = () => {
  ...
  return (
    <>
    <div className='main-container' style={{backgroundColor: '#3A0066', position: 'absolute', height: '100%', width: '100%'}}>
        <Navbar />
        ...
        <section className='p-md-5' style={{backgroundColor: '#3A0066'}}>
            <div className='container'>
                <div className='row g-4 p-4 justify-content-center align-items-center'>
                    <div className='col-lg-3 col-md-12'><RecipeCard /></div>
                    <div className='col-lg-4 col-md-12'><SearchCard /></div>
                    <div className='col-lg-4 col-md-12'><SignOutCard /></div>
                </div>
            </div>
        </section>
    </div>
